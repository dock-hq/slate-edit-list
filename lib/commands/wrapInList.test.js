...
describe('wrapInList command', () => {
  ...
  describe('should wrap items in a list', () => {
    ...
    describe('with advanced selection: ', () => {
      ...
      it('multiple paragraphs (same level) with backwards selection', () => {
        editor.children = [
          { type: 'paragraph', children: [{ text: 'First item' }] },
          {
            type: 'paragraph',
        ...
        // Backwards selection: anchor is after focus
        Transforms.select(editor, {
          anchor: {
            path: [1, 0],
            offset: 11, // End of "Second item"
          },
          focus: {
            path: [0, 0],
            offset: 0, // Start of "First item"
          },
        });
        Transforms.wrapInList(editor);
